...
│   ├── Tier 10      (Icona 34x34 a sx di Hot Streak, Pushing the Limit / +12% Haste per 5s con Pixel Glow)
...
│   └── 04 - Focus Magic      (x = -150, y = -14: Nascosta se applicata, Proc 10s countdown, OFF rosso se non assegnata o alleato morto)
│
...
│   ├── Haste: Spell Haste (viola, include rating + moltiplicatori Bloodlust/Totem/3% raid + T10 2P + PI + Berserking, supporto 3 cifre es. 110.99%)
...
│   │
│   ├── Scenario A: 7 Icone T8 (Equipaggiati >= 2 pezzi T8 - 28x28px, passo 38px):
...
│   │   ├── 06 - Tier 8       (x =    0: Praxis +350 SP per 15s con Glow dorato + Swipe ICD)
...
│   │   └── 06 - Mirror Image (x = +114: Glow attivo 30s + proc 4P T10 + Swipe orologio CD 3m)
│   │
│   └── Scenario B: 6 Icone Standard (< 2 pezzi T8 - 28x28px, passo 44px, Tier 8 nascosto):
...
│       └── 06 - Mirror Image (x = +110: Glow attivo 30s + proc 4P T10 + Swipe orologio CD 3m)
│
